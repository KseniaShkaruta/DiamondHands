...
#download file if it doens't exist
if(!file.exists('/srv/shiny-server/apps/data/posts_with_scores_and_ticker.csv')){
  fp = "https://dva-sp2021-team38.s3.amazonaws.com/public/posts_with_scores_and_ticker.csv"
  download.file(fp,destfile="/srv/shiny-server/apps/data/posts_with_scores_and_ticker.csv",method='wget')
}
